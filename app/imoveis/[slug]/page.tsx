            ...
            <div className="rounded-xl border border-green-100 bg-green-50 p-6">
              ...
              <div className="mt-4 flex flex-col gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex min-h-[44px] items-center justify-center gap-2 rounded-full border border-zinc-200 bg-white px-4 py-3 text-sm font-medium text-zinc-800 transition-colors hover:border-green-500/40 hover:bg-zinc-50"
                  aria-label="Compartilhar este imóvel no WhatsApp"
                >
                  <Share2
